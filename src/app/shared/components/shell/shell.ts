 ...
 * `.shell__brand` (переключатель `.shell__menu-toggle`, затем лого, затем —
 * только в широком виде — разделитель `.shell__divider`; в компактном и
 * среднем виде переключатель ОДНО место в разметке — не два разных, как
